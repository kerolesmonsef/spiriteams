...
function setDBConnectionBasedOnSubDomain($args = [])
{
    ...
    config(['database.connections.tenant_template.database' => $tenant->tenancy_db_name]);
...
if (!function_exists('resource_collection')) {
    ...
    function resource_collection(AnonymousResourceCollection $resource): array
    {
