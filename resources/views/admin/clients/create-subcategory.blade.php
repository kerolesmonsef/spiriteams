<div class="modal-header">
    ...
    <h4 class="modal-title">@lang('modules.client.clientSubCategory')</h4>
</div>
    ...
    <div class="portlet-body">
        <div class="table-responsive">
            <table class="table">
                ...
                @empty
                    <tr>
                        <td colspan="3">@lang('messages.noSubCategory')</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
        ...
        <div class="form-body">
            ...
            <div class="form-group">
              <label for="">@lang('modules.client.clientCategory')</label>
               <select class="select2 form-control" data-placeholder="@lang('modules.client.clientCategory')"  id="category_id" name="category_id">
                ...
                <div class="col-xs-12 ">
                    <div class="form-group">
                        <label class="required"> @lang('modules.projectCategory.subcategoryName')</label>
