    ...
    <div class="white-box">
                ...
                <div id="sortable">
                    @foreach ($leadFormFields as $item)
                        <div class="row p-10 b-b">
                            ...
                            <div class="col-xs-5">@lang('modules.leads.'.$item->field_name)</div>
                            <div class="col-xs-5">
                                @if($item->required == 0)
                        ...
                        @if($global->google_recaptcha == 1)
                            <div class="row p-10 b-b">
                                ...
                                <div class="col-xs-5">
                                    <div class="switchery-demo">
                                        <input type="checkbox"
                                               @if($global->lead_form_google_captcha == 1) checked
                                               @endif class="js-switch change-setting"
                                               data-color="#99d683" data-size="small"
                                               data-setting-id="0"/>
                                    </div>
        ...
        <div class="col-md-6">
            <div class="white-box b-all">
                ...
                <hr>
                <iframe src="{{ route('front.leadForm') }}" id="previewIframe" width="100%" onload="resizeIframe(this)" frameborder="0"></iframe>
            </div>
        </div>
    </div>
</div>
