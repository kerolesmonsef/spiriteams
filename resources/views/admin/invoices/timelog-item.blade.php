    ...
    <div class="col-xs-12 item-row margin-top-5">
        ...
        @if($invoiceSetting->hsn_sac_code_show)
            <div class="col-md-1">
                ...
                <input type="text" class="form-control" name="hsn_sac_code[]"  value="{{ $item->hsn_sac_code }}">
        ...
        @endif
            ...
            <div class="form-group">
                ...
                <input type="number" min="1" readonly class="form-control quantity" value="1" name="quantity[]" >
            </div>
        </div>
        <div class="col-md-2">
            <div class="row">
