                ...
                <div class="panel-body">
                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 ">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="office" id="office" value="{{ $leadDetail->office ?? '' }}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-md-3 ">
                            ...
                            <div class="col-md-3 ">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="country" id="country"
                                        value="{{ $leadDetail->country ?? '' }}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-3 ">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-3 ">
                                <div class="form-group">
                                    <label>@lang('modules.lead.industry')</label>
                            ...
                            <div class="col-md-3 ">
                                <div class="form-group">
                                    <label>@lang('modules.lead.feedback')</label>
                            ...
                            <div class="col-md-3 ">
                                <div class="form-group">
                                    <label>@lang('modules.lead.service')</label>
                                    <input type="text" name="service" id="service" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-3 ">
                                <div class="form-group">
                                    <label>@lang('modules.lead.project_id')</label>
                            ...
                            <div class="col-md-3 ">
                                <div class="form-group">
                                    <label>@lang('modules.lead.qol')</label>
                                    <select name="qol" class="select2 form-control">
                                        @foreach (trans('modules.lead.qol_values') as $key=>$value)
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="">@lang('modules.tickets.chooseAgents') <a href="javascript:;"
                                            id="addLeadAgent" class="btn btn-sm btn-outline btn-success"><i
                                                class="fa fa-plus"></i></a></label>
                                    <select class="select2 form-control"
                                        data-placeholder="@lang('modules.tickets.chooseAgents')" id="agent_id"
                                        name="agent_id">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="">@lang('modules.lead.leadSource')
                                        <a href="javascript:;" id="addLeadsource"
                                            class="btn btn-sm btn-outline btn-success"><i class="fa fa-plus"></i></a>
                                    </label>
                                    <select class="select2 form-control"
                                        data-placeholder="@lang('modules.lead.leadSource')" id="source_id"
                                        name="source_id">
                            ...
                            <div class="col-md-3" style="margin-top: 11px;">
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" data-placeholder="@lang('app.status')"
