    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"><i
                        class="{{ $pageIcon }}"></i> @lang($pageTitle) @lang('modules.holiday.listOf') {{ \Carbon\Carbon::now()->format('Y') }}
            </h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <a onclick="showAdd()"
               class="btn btn-outline btn-success btn-sm pull-right m-l-5">@lang('modules.holiday.addNewHoliday') <i
                        class="fa fa-plus" aria-hidden="true"></i></a>

            <a href="javascript:;" onclick="calendarData()"
               class="btn btn-outline btn-info btn-sm pull-right m-l-5">@lang('modules.holiday.viewOnCalendar') <i
                        class="fa fa-calendar" aria-hidden="true"></i></a>

            <a class="btn btn-outline btn-sm btn-primary markHoliday pull-right" onclick="showMarkHoliday()"
               href="javascript:;">@lang('modules.holiday.markSunday') <i class="fa fa-check"></i> </a>

            <ol class="breadcrumb">
                <li><a href="{{ route('admin.dashboard') }}">@lang('app.menu.home')</a></li>
                <li class="active">@lang($pageTitle) @lang('modules.holiday.listOf') {{ \Carbon\Carbon::now()->format('Y') }}</li>
            </ol>
        </div>
        <!-- /.breadcrumb -->
    </div>
    ...
    <script>
        ...
        function del(id, date) {
            ...
            swal({
                ...
                text: "@lang('messages.deleteHolidayText')",
                type: "warning",
