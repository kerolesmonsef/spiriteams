            ...
            <div id="addMoreBox1" class="clearfix">
                <div class="col-md-5">
                    <div id="dateBox" class="form-group ">
                        <input class="form-control date-picker" autocomplete="off" id="dateField1"
...
<div class="modal-footer">
    ...
    <button type="button" onclick="storeHolidays()" class="btn btn-info save-event waves-effect waves-light"><i
