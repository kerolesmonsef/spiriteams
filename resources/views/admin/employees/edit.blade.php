                                    ...
                                    <div class="form-group">
                                        <label class="required">@lang('app.designation')
                                            <button id="designation-setting" type="button"
                                                    class="btn btn-xs btn-outline btn-info"><i
                                                        class="ti-settings"></i> @lang('messages.manageDesignation')
                                            </button>
                                        </label>
                                        <select name="designation" id="designation" class="form-control">
                                            <option value="">--</option>
                                            @forelse($designations as $designation)
                                                <option @if($employeeDetail && $employeeDetail->designation_id == $designation->id) selected
                                    ...
                                    <div class="form-group">
                                        <label class="required">@lang('app.department')
                                            <button id="department-setting" type="button"
                                                    class="btn btn-xs btn-outline btn-info"><i
                                                        class="ti-settings"></i> @lang('messages.manageDepartment')
                                            </button>
                                        </label>
                                        <select name="department" id="department" class="form-control">
                                            <option value="">--</option>
                                            @foreach($teams as $team)
                                                <option @if($employeeDetail && $employeeDetail->department_id == $team->id) selected
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off" name="last_date" id="end_date"
                                               value="@if($employeeDetail && $employeeDetail->last_date) {{ $employeeDetail->last_date->format($global->date_format) }} @endif"
                                               class="form-control">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 ">
                                    <div class="form-group">
                                        ...
                                        <input name='tags' placeholder='@lang('app.skills')'
                                               value='{{implode(',', $userDetail->skills()) }}'>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step=".01" min="0" name="hourly_rate" id="hourly_rate"
                                               class="form-control"
                                ...
                                <div class="col-md-3 ">
                                    <div class="form-group">
                                        ...
                                        <select name="login" id="login" class="form-control">
                                            <option @if($userDetail->login == 'enable') selected
                                                    @endif value="enable">@lang('app.enable')</option>
                                            <option @if($userDetail->login == 'disable') selected
                                                    @endif value="disable">@lang('app.disable')</option>
                                        </select>
                                    </div>
                                </div>
