...
@section('content')
                ...
                <nav>
                    <ul>
                        <li class="tab-current"><a
                                    href="{{ route('admin.attendances.summary') }}"><span>@lang('app.summary')</span></a>
                        </li>
                        <li>
                            <a href="{{ route('admin.attendances.index') }}"><span>@lang('modules.attendance.attendanceByMember')</span></a>
                        </li>
                    ...
                    <div class="col-md-2">
                        <div class="form-group m-t-20">
                            <button type="button" id="apply-filter"
                                    class="btn btn-info btn-block">@lang('app.apply')</button>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="white-box">
                <strong>@lang('app.note'):</strong> <i class="fa fa-star text-warning"></i> <i
                        class="ti-arrow-right"></i> @lang('app.menu.holiday') | <i class="fa fa-check text-success"></i>
                <i class="ti-arrow-right"></i> @lang('modules.attendance.present') | <i
                        class="fa fa-times text-danger"></i> <i
                        class="ti-arrow-right"></i> @lang('modules.attendance.absent')
            </div>
        </div>
    </div>
