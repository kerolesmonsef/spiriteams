                    ...
                    @foreach($dateData['attendance'] as $attendance)
                        <tr>
                            ...
                            <td width="25%" class="al-center bt-border text-center">
                                @if(!is_null($attendance->clock_out_time)) {{ $attendance->clock_out_time->timezone($global->timezone)->format($global->time_format) }} @else
                                    - @endif
                            </td>
                            <td class="bt-border al-center text-center" style="padding-bottom: 5px;">

                                <button type="button" class="btn btn-info btn-xs btn-rounded view-attendance"
