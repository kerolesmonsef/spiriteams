...
<div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
            ...
            <a class="btn btn-default btn-outline btn-sm"  href="{{ route("front.contractDownloads", $contract->id) }}"> <span><i class="fa fa-file-pdf-o"></i> @lang('modules.invoices.downloadPdf')</span> </a>
                                                                                    ...
                                                                                    <p class="text-muted">
                                                                                        ...
                                                                                        <ul>
                                                                                            @foreach($field->values as $key => $value)
                                                                                                @if($contract->custom_fields_data['field_'.$field->id] != '' && in_array($value ,explode(', ', $contract->custom_fields_data['field_'.$field->id]))) <li>{{$value}}</li> @endif
                                                                                            @endforeach
                                                                                        </ul>
                                                                                        @elseif($field->type == 'date')
                                                                                            {{ !is_null($contract->custom_fields_data['field_'.$field->id]) ? \Carbon\Carbon::parse($contract->custom_fields_data['field_'.$field->id])->format($global->date_format) : '--'}}
                                                                                        @endif
                                                                                    </p>
