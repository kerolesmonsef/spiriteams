...
<div id="wrapper">
    ...
    <h6 style="text-align:center;">بسم الله الرحمن الرحيم</h6>    
     ...
     <p style="text-align:right; font-size:18px;font-weight:bold;font-family: -webkit-body;">
      الحمد لله والصلاة والسلام على رسول الله ، تم بعون الله إبرام هذا ("العقد") في يوم الأربعاء الموافق 24/08/ 2022م -26 / 1/1444 ، في مدينة جدة بين كلاً من     </p>
    </div>
    ...
    <div class="col-md-12">
       ...
       <p style="direction: rtl;text-align: right;font-size:16px;">
        سجل تجاري رقم (4030008182) الرقم الضريبي ({{$contract->client->client_details->gst_number}}) وعنوانها مدينة {{$contract->client->client_details->city}}، الرمز البريدي {{$contract->client->client_details->postal_code}} ويمثله الأستاذ/ {{$contract->client->name}} - رقم الجوال ({{$contract->client->mobile}})، البريد الإلكتروني: {{$contract->client->email}} ، بصفته مدير الشركة ، (ويشار إليه فيما بعد بـ "الطرف الثاني")      </p>
    </div>
</div>
    <div class="col-md-12">
...
<div class="col-md-12">
    <h5 style="background-color: lavender;direction: rtl;text-align:right;font-size:16px;font-weight:bold;">۳.	مدة العقد</h5>
     <p style="direction: rtl;text-align:right; font-size:16px;">
اتفق الطرفان على أن مده هذا العقد (عام ميلادي) يبدأ من تاريخ تسليم المنصة. وقبل انتهاء مدة العقد يحق لأحد الطرفين إشعار الطرف الآخر بفسخ العقد أو القيام بأي تعديل على أن يتم الإخطار قبل نهاية العقد بـ 30 يوم 
     </p>
</div>
<div class="col-md-12">
...
<div class="col-md-12">
    <h5 style="background-color: lavender;direction: rtl;text-align:right;font-size:18px;font-weight:bold;"> ٧.  المنازعات</h5>
     <p style="direction: rtl;text-align:right; font-size:16px;">
على ان تكون المحاكم السعودية بجدة هيا المحاكم المختصة في حال حدوث أي نزاع لا سمح الله 
     </p>
</div>    
...
<div class="col-md-12">
    <h5 style="background-color: lavender; direction: rtl;text-align:right;font-size:18px;font-weight:bold;">٩.  نسخ العقد</h5>
     <p style="direction: rtl;text-align:right; font-size:16px;">
