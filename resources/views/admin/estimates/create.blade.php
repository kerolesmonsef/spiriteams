                        ...
                        <div class="form-body">
                                ...
                                <div class="col-xs-12 item-row margin-top-5">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                    <textarea name="item_summary[]" class="form-control " placeholder="@lang('app.description')" rows="4"></textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">كود عرض السعر بالنسبة للبائع</label>
