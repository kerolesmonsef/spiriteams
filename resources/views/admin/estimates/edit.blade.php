                                    ...
                                    @foreach($fields as $field)
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="custom_fields_data[{{$field->name.'_'.$field->id}}]" class="form-control" id="{{$field->name}}" cols="5">{{$estimate->custom_fields_data['field_'.$field->id] ?? ''}}</textarea>                                    @elseif($field->type == 'radio')
                                            ...
                                            {!! Form::select('custom_fields_data['.$field->name.'_'.$field->id.']', $field->values,
