                ...
                <select class="selectpicker language-switcher " data-width="fit">
                    ...
                    @foreach($languageSettings as $language)
                        <option value="{{ $language->language_code }}"
                                ...
                                @endif  data-content='<span class="flag-icon @if($language->language_code == 'zh-CN') flag-icon-cn @elseif($language->language_code == 'zh-TW') flag-icon-tw @else flag-icon-{{ $language->language_code == 'ar' ? 'sa' : $language->language_code }} @endif"></span>'>{{ $language->language_code }}</option>
                    @endforeach
                </select>
