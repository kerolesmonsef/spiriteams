...
<div class="modal-body">
    <div class="portlet-body">
        ...
        {!! Form::open(['id'=>'storeTask','class'=>'ajax-form','method'=>'POST','files'=>true]) !!}
        ...
        <div class="form-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="start_date" value="{{ now()->format("d/m/Y") }}" id="start_date2" class="form-control" autocomplete="off">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label required">@lang('app.dueDate')</label>
                        <input type="text" name="due_date" value="{{ now()->format("d/m/Y") }}" autocomplete="off" id="due_date2" class="form-control">
                    </div>
                </div>
                <!--/span-->
            </div>
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select class="select2 select2-multiple " multiple="multiple"
                            ...
                            @forelse($employees as $employee)
                                <option value="{{ $employee->id }}" {{ $employee->id == auth()->id() ? "selected" : "" }}>{{ ucwords($employee->name) }}</option>
                            @empty
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label">@lang('modules.projects.uploadFile') </label>
    ...
    $('#task_project_id').change(function () {
        ...
        $.easyAjax({
            ...
            success: function (data) {
                ...
                {{--$('#user_id option[value="{{ auth()->id() }}"]').prop('selected', true)--}}
            }
        })
