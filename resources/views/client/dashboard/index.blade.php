            ...
            <div class="col-md-6 pull-right hidden-xs hidden-sm">
                ...
                <select class="selectpicker language-switcher  pull-right" data-width="fit">
                    ...
                    @foreach($languageSettings as $language)
                        <option value="{{ $language->language_code }}" @if($user->locale == $language->language_code) selected @endif  data-content='<span class="flag-icon flag-icon-{{ $language->language_code == 'ar' ? 'sa' : $language->language_code }}"></span>'>{{ $language->language_code }}</option>
                    @endforeach
                </select>
            </div>
