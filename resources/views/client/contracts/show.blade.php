                                    ...
                                    <div class="tab-content tabcontent-border">
                                        ...
                                        <div class="tab-pane  p-20" id="files" role="tabpanel">
                                            ...
                                            <div class="row m-b-20 hide" id="file-dropzone">
                                                <div class="col-md-12">
                                                    <form action="{{ route('client.contract-files.store') }}" class="dropzone"
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        ...
                                                                        @if(is_null($file->external_link))
                                                                            &nbsp;&nbsp;
                                                                            <a href="{{ route('client.contract-files.download', $file->id) }}"
...
//        maxFilesize: 2, // MB,
    ...
    $('body').on('click', '.sa-params', function () {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('client.contract-files.destroy',':id') }}";
                url = url.replace(':id', id);
    ...
    $('.thumbnail').on('click', function(event) {
        ...
        $.easyAjax({
            type: 'GET',
            url: "{{ route('client.contract-files.thumbnail') }}",
            data: {
                id: contractID
            },
            success: function (response) {
    ...
    $('#save-link').click(function () {
        $.easyAjax({
            url: '{{route('client.contract-files.storeLink')}}',
