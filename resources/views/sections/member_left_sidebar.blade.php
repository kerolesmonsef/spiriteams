...
<div class="navbar-default sidebar" role="navigation">
    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
            ...
            <!--<li><a href="{{ url('member/client-dashboard') }}" class="waves-effect"><i class="icon-speedometer fa-fw"></i> <span class="hide-menu">لوحة المعلومات للعملاء</span></a> </li>-->
            ...
            <li><a href="{{ route('member.task.index') }}" class="waves-effect"><i class="fa fa-tasks fa-fw"></i> <span class="hide-menu"> @lang('app.menu.tasks') <span class="fa arrow"></span> </span></a>
                <ul class="nav nav-second-level">
                    ...
                    <li class="hidden-sm hidden-xs"><a href="{{ route('member.taskboard.index_2') }}">@lang('modules.tasks.taskBoard')</a></li>
