...
<head>
    ...
    <meta name="msapplication-TileImage" content="{{ $settings->favicon_url }}">
    ...
    <div id="page-wrapper" style="margin-left: 0px !important;">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <img src="{{ invoice_setting()->logo_url }}" alt="home" class="admin-logo"/>
                </div>
                        ...
                        <div class="card-body">
                            <div class="white-box printableArea ribbon-wrapper" style="background: #ffffff !important;">
                                <div class="ribbon-content p-20" id="invoice_container">
                                    ...
                                    @endif
                                    <h4 class="text-right"><b>@lang('app.mproposal')</b> </h4>
                                    <hr>
