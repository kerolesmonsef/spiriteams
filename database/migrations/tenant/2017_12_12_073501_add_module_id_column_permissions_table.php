...
class AddModuleIdColumnPermissionsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Permission::insert([
            ...
            ['name' => 'add_column_task', 'display_name' => 'add_column_task', 'module_id' => 12],
            ['name' => 'view_column_task', 'display_name' => 'view_column_task', 'module_id' => 12],
            ['name' => 'edit_column_task', 'display_name' => 'edit_column_task', 'module_id' => 12],
            ['name' => 'delete_column_task', 'display_name' => 'delete_column_task', 'module_id' => 12],
        ]);
