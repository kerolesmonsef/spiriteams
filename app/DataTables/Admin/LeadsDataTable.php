...
class LeadsDataTable extends BaseDataTable
{
    ...
    public function query(User $model)
    {
        ...
        $lead =
         Lead::select('leads.id', 'leads.client_id', 'leads.next_follow_up', 'client_name', 'company_name', 'note','lead_status.type as statusName', 'status_id','leads.value', 'leads.created_at', 'lead_sources.type as source', 'users.name as agent_name', 'users.image',
