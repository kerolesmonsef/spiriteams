...
class StoreRequest extends CoreRequest
{
    ...
    public function rules()
    {
        ...
        if($this->has('type')){
            ...
            return [
                'next_follow_up_date' => [new CheckDateFormat(null, $setting->date_format),new CheckEqualAfterDate('',$setting->date_format, $lead->created_at->format($setting->date_format))],
            ];
        }
    }
}
