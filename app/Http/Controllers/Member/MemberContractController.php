...
class MemberContractController extends MemberBaseController
{
    ...
    public function download($id)
    {
        ...
        $pdf->loadView('member.contracts.contract-pdf', ['contract' => $contract,'global' => $global]);
        ...
        return view('member.contracts.contract-pdf',['contract' => $contract,'global' => $global, 'fields'=>$fields]);
    }
