...
class TicketTypesController extends AdminBaseController
{
    ...
    public function store(StoreTicketType $request)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.ticketTypeAddSuccess'));
    ...
    public function update(UpdateTicketType $request, $id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.ticketTypeUpdateSuccess'));
    ...
    public function destroy($id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.ticketTypeDeleteSuccess'));
