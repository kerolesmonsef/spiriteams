...
class ManageEstimatesController extends AdminBaseController
{
      ...
      public function estimateView($id)
    {
        ...
        $this->estimate = Estimate::whereRaw('md5(id) = ?', $id)->firstOrFail();
    ...
    public function store(StoreEstimate $request)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.estimateCreated'));
    ...
    public function update(StoreEstimate $request, $id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.estimateUpdated'));
    ...
    {
        Estimate::destroy($id);
        $this->logUserActivity($this->user->id, __('messages.estimateDeleted'));
