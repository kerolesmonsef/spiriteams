...
class ManageTimeLogsController extends AdminBaseController
{
    ...
    public function store(StoreTimeLog $request)
    {
        ...
        if (is_null($activeTimer)) {
            ...
            $this->logUserActivity($this->user->id, __('messages.timeLogAdded'));
    ...
    public function destroy($id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.timeLogDeleted'));
    ...
    public function update(UpdateTimeLog $request, $id)
    {
        ...
        if (is_null($activeTimer)) {
            ...
            $timeLog->edited_by_user = $this->user->id;
            $timeLog->save();
            $this->logUserActivity($this->user->id, __('messages.timeLogUpdated'));
    ...
    public function stopTimer(Request $request)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.timerStoppedSuccessfully'));
