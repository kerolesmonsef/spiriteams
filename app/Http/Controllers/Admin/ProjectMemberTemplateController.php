...
class ProjectMemberTemplateController extends AdminBaseController
{
    ...
    public function store(StoreProjectMembers $request)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.templateMembersAddedSuccessfully'));
    ...
    public function destroy($id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.templateMemberRemovedFromProject'));
    ...
    public function storeGroup(SaveGroupMembers $request)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.membersAddedSuccessfully'));
