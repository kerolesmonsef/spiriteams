...
//        dd($request->all());
    ...
    public function store(StoreRecurringExpense $request)
    {
        ...
        $expense->save();
        $this->logUserActivity($this->user->id, __('messages.expenseSuccess'));
    ...
    public function update(StoreRecurringExpense $request, $id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.expenseUpdateSuccess'));
    ...
    public function destroy($id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.expenseDeleted'));
