...
class LeadSourceSettingController extends AdminBaseController
{
    ...
    public function storeAgent(StoreLeadSource $request)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.leadSourceAddSuccess'));
    ...
    public function update(UpdateLeadSource $request, $id)
    {
        ...
        $type->save();
        $this->logUserActivity($this->user->id, __('messages.leadSourceUpdateSuccess'));
    ...
    public function destroy($id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.leadSourceDeleteSuccess'));
