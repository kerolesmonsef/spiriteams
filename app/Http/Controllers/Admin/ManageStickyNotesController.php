...
class ManageStickyNotesController extends AdminBaseController
{
    ...
    public function store(StoreStickyNote $request)
    {
        ...
        $sticky->save();
        session()->forget('user');
        $this->logUserActivity($this->user->id, __('messages.noteCreated'));
    ...
    public function update(UpdateStickyNote $request,$id)
    {
        ...
        session()->forget('user');
        $this->logUserActivity($this->user->id, __('messages.noteUpdated'));
    ...
    public function destroy($id)
    {
        ...
        session()->forget('user');
        $this->logUserActivity($this->user->id, __('messages.noteDeleted'));
