...
class AdminProductController extends AdminBaseController
{
    ...
    public function store(StoreProductRequest $request)
    {
        ...
        $products->save();
        $this->logUserActivity($this->user->id,__('messages.productAdded'));
    ...
    public function update(UpdateProductRequest $request, $id)
    {
        ...
        $this->logUserActivity($this->user->id,__('messages.productUpdated'));
    ...
    {
        Product::destroy($id);
        $this->logUserActivity($this->user->id,__('messages.productDeleted'));
