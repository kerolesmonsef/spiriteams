...
class ProposalController extends AdminBaseController
{
    ...
    public function sendProposal($id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.proposalSendSuccess'));
    ...
    public function store(StoreRequest $request)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.proposalCreated'));
    ...
    public function update(StoreRequest $request, $id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.proposalUpdated'));
    ...
    {
        Proposal::destroy($id);
        $this->logUserActivity($this->user->id, __('messages.proposalDeleted'));
