...
class TicketReplyTemplatesController extends AdminBaseController
{
    ...
    public function store(StoreTemplate $request)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.templateAddSuccess'));
    ...
    public function update(UpdateTemplate $request, $id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.templateUpdateSuccess'));
    ...
    public function destroy($id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.templateDeleteSuccess'));
