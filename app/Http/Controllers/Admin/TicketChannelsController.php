...
class TicketChannelsController extends AdminBaseController
{
    ...
    public function store(StoreTicketChannel $request)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.ticketChannelAddSuccess'));
    ...
    public function update(UpdateTicketChannel $request, $id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.ticketChannelUpdateSuccess'));
    ...
    public function destroy($id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.ticketChannelDeleteSuccess'));
