...
class OfflinePaymentSettingController extends AdminBaseController
{
    public function __construct() {
        ...
        $this->pageTitle = 'app.menu.offlinePaymentMethod';
    ...
    public function store(StoreRequest $request)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.methodsAdded'));
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.methodsUpdated'));
    ...
    public function destroy($id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.methodsDeleted'));
