...
class DiscussionCategoryController extends AdminBaseController
{
    ...
    public function store(StoreRequest $request)
    {
        ...
        $this->logUserActivity($this->user->id,__('messages.recordSaved'));
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        $this->logUserActivity($this->user->id,__('messages.recordUpdated'));
    ...
    public function destroy($id)
    {
        ...
        $this->logUserActivity($this->user->id,__('messages.recordDeleted'));
