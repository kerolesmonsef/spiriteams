...
class CurrencySettingController extends AdminBaseController
{
    ...
    public function store(StoreCurrency $request)
    {
        ...
        $this->logUserActivity($this->user->id,__('messages.currencyAdded'));
    ...
    public function update(StoreCurrency $request, $id)
    {
        ...
        $currency->save();
        $this->logUserActivity($this->user->id,__('messages.currencyUpdated'));
    ...
    public function destroy($id)
    {
        ...
        Currency::destroy($id);
        $this->logUserActivity($this->user->id,__('messages.currencyDeleted'));
    ...
    {
        $this->updateExchangeRates();
        $this->logUserActivity($this->user->id,__('messages.exchangeRateUpdateSuccess'));
    ...
    public function currencyExchangeKeyStore(StoreCurrencyExchangeKey $request)
    {
        ...
        $this->global->save();
        $this->logUserActivity($this->user->id,__('messages.currencyConvertKeyUpdated'));
