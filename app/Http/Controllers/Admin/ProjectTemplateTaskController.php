...
class ProjectTemplateTaskController extends AdminBaseController
{
    ...
    public function store(StoreTask $request)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.templateTaskCreatedSuccessfully'));
    ...
    public function update(StoreTask $request, $id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.templateTaskUpdatedSuccessfully'));
