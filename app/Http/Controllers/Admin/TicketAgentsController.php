...
class TicketAgentsController extends AdminBaseController
{
    ...
    public function store(StoreAgentGroup $request)
    {
        ...
        if (request()->ajax()) {
            ...
            $this->logUserActivity($this->user->id, __('messages.agentAddedSuccessfully'));
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.statusUpdatedSuccessfully'));
    ...
    public function updateGroup(Request $request, $id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.groupUpdatedSuccessfully'));
    ...
    public function destroy($id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.agentRemoveSuccess'));
