...
class ManagePaymentsController extends AdminBaseController
{
    ...
    public function store(StorePayment $request)
    {
       ...
       if ($request->has('invoice_id')  && $request->get('invoice_id') != "") {
        ...
        $this->logUserActivity($this->user->id, __('messages.paymentSuccess'));
    ...
    public function destroy($id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.paymentDeleted'));
    ...
    public function importExcel(ImportPayment $request)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.importSuccess'));
