...
class ManageAllCreditNotesController extends AdminBaseController
{
    ...
    public function destroy($id)
    {
        ...
        if ($firstCreditNote->id == $id) {
            ...
            $this->logUserActivity($this->user->id, __('messages.creditNoteDeleted'));
            return Reply::success(__('messages.creditNoteDeleted'));
        } else {
            $this->logUserActivity($this->user->id, __('messages.creditNoteCanNotDeleted'));
    ...
    public function store(StoreCreditNotes $request)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.creditNoteCreated'));
    ...
    public function applyToInvoice(Request $request, $id)
    {
        ...
        $creditNote->save();
        $this->logUserActivity($this->user->id, __('messages.creditNoteAppliedSuccessfully'));
