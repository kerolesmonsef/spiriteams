...
class ManageProjectsController extends AdminBaseController
{
    ...
    public function destroy($id)
    {
        ...
        $project->forceDelete();
        $this->logUserActivity($this->user->id, __('messages.projectDeleted'));
    ...
    public function archiveDestroy($id)
    {
        ...
        Project::destroy($id);
        $this->logUserActivity($this->user->id, __('messages.projectArchiveSuccessfully'));
    ...
    public function archiveRestore($id)
    {
        ...
        $project = Project::withTrashed()->findOrFail($id);
        $project->restore();
        $this->logUserActivity($this->user->id, __('messages.projectRevertSuccessfully'));
