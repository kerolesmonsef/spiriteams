...
class ManageEmployeesController extends AdminBaseController
{
    ...
    public function store(StoreRequest $request)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.employeeAdded'));
    ...
    public function show($id)
    {
        ...
        $this->employeeTarget = EmployeeTraget::where('user_id', '=', $this->employee->id)->get();
        $this->employeeTargetCurrent = EmployeeTragetCurrnet::where('user_id', '=', $this->employee->id)->get();
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.employeeUpdated'));
        // To add custom fields data
        if ($request->get('custom_fields_data')) {
            $employee->updateCustomFieldData($request->get('custom_fields_data'));
        }
    ...
    public function destroy($id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.employeeDeleted'));
    ...
    public function targetCreate(Request $request, $id)
    {
        //dd('ddd');
        $this->employeeID = $id;
        return view('admin.employees.target-create', $this->data);
    }
    public function targetCreateCurrent(Request $request, $id)
    {
        //dd('ddd');
        $this->employeeID = $id;
        return view('admin.employees.targetcurrent-create', $this->data);
    }
    ...
    public function leaveTypeUpdate(Request $request, $id)
    {
        ...
        session()->forget('user');
        $this->logUserActivity($this->user->id, __('messages.leaveTypeAdded'));
