...
class ManageNoticesController extends AdminBaseController
{
    ...
    public function store(StoreNotice $request)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.noticeAdded'));
    ...
    public function update(StoreNotice $request, $id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.noticeUpdated'));
    ...
    {
        Notice::destroy($id);
        $this->logUserActivity($this->user->id, __('messages.noticeDeleted'));
