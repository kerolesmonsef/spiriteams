...
class AdminContractTypeController extends AdminBaseController
{
    ...
    public function store(StoreRequest $request) {
        ...
        $this->logUserActivity($this->user->id,__('messages.contractTypeAdded'));
    ...
    public function update(UpdateRequest $request, $id) {
        ...
        $contract->name = $request->name;
        $contract->save();
        $this->logUserActivity($this->user->id,__('messages.contractTypeUpdated'));
    ...
    public function destroy($id) {
        ...
        $contractTypeData = ContractType::all();
        $this->logUserActivity($this->user->id,__('messages.contractTypeDeleted'));
