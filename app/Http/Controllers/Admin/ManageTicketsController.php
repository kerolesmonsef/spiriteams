...
class ManageTicketsController extends AdminBaseController
{
    ...
    public function store(StoreTicket $request)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.ticketAddSuccess'));
    ...
    public function update(UpdateTicket $request, $id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.ticketReplySuccess'));
    ...
    {
        Ticket::destroy($id);
        $this->logUserActivity($this->user->id, __('messages.ticketDeleteSuccess'));
