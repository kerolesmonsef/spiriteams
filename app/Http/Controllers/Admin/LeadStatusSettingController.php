...
class LeadStatusSettingController extends AdminBaseController
{
    ...
    public function store(StoreLeadStatus $request)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.leadStatusAddSuccess'));
    ...
    public function update(UpdateLeadStatus $request, $id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.leadStatusUpdateSuccess'));
    ...
    public function destroy($id)
    {
        ...
        $this->logUserActivity($this->user->id, __('messages.leadStatusDeleteSuccess'));
