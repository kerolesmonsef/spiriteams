...
Route::get('/estimate/download/{id}', ['uses' => 'HomeController@downloads'])->name('front.estimateDownload');
Route::get('contracts/downloads/{id}', ['uses' => 'PublicUrlController@contractDownloadView'])->name('front.contractDownloads');
...
Route::get('/download/{id}', ['uses' => 'HomeController@download'])->name('front.download');
Route::get('/downloads/{id}', ['uses' => 'HomeController@downloads'])->name('front.downloads');
...
Route::get('/crm-login', ['uses' => 'HomeController@crmLogin']);
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(
        ...
        Route::group(
            ...
            Route::get('employees/target-create/{id}', ['uses' => 'ManageEmployeesController@targetCreate'])->name('employees.target-create');
            Route::get('employees/targetcurrent-create/{id}', ['uses' => 'ManageEmployeesController@targetCreateCurrent'])->name('employees.targetcurrent-create');
            ...
            Route::resource('employee-traget', 'EmployeeTragetController');
            Route::resource('employee-tragetcurrent', 'EmployeeTragetCurrentController');
        });
...
//            Route::resource('time-settings', 'TimeSettingsController');
        ...
        Route::group(
            ...
            Route::put('approve_or_reject_requisition/{id}' , 'ManageAllTasksController@approveOrRejectRequisition');
            ...
            Route::get('taskboard_2', 'AdminTaskboardController@index_2')->name("taskboard.index_2");
            Route::get("taskboard_2/columnTasks","AdminTaskboardController@columnTasks")->name("taskboard.columnTasks");
        ...
        Route::group(
            ...
            Route::get('single-report', 'LeadReportController@sorting_traget');
        ...
        Route::group(
            ...
            Route::get('all-invoices/refunds', ['uses' => 'ManageAllInvoicesController@refunds'])->name('all-invoices.refunds');
            Route::get('all-invoices/refund-invoice/{invoiceId}', ['uses' => 'ManageAllInvoicesController@refundInvoice'])->name('all-invoices.refundInvoice');
            Route::post('all-invoices/add-refund-invoice/{invoiceId}', ['uses' => 'ManageAllInvoicesController@addRefundInvoice'])->name('all-invoices.addRefundInvoice');
    ...
    Route::group(
        ...
        //endregion
            //Route::get('all-invoices/update-item', ['uses' => 'MemberProposalController@addItems'])->name('all-invoices.update-item');
        //region contracts type routes
        ...
        Route::get('/client-dashboard', 'MemberDashboardController@clientDashboard')->name('clientDashboard');
        ...
        Route::group(
            ...
            Route::get('taskboard_2', 'MemberTaskboardController@index_2')->name("taskboard.index_2");
            Route::resource('taskboard', 'MemberTaskboardController');
            Route::get("taskboard_2/columnTasks","MemberTaskboardController@columnTasks")->name("taskboard.columnTasks");
        ...
        Route::get('employees/target-create/{id}', ['uses' => 'MemberEmployeesController@targetCreate'])->name('employees.target-create');
        Route::get('employees/targetcurrent-create/{id}', ['uses' => 'MemberEmployeesController@targetCreateCurrent'])->name('employees.targetcurrent-create');
